from algorithms.utils import standardize_path, LAYOUT_METRO, LAYOUT_METRO_GUI, LAYOUT_ARBRE, LAYOUT_ARBRE_GUI
import os
...
class DFS:
    ...
    def visualiser_parcours(self, parcours, parent, start_node, file_name='dfs_visualization.png', fig=None):
        # Gère le mode interactif (GUI) ou sauvegarde fichier
        ...
        if dfs_tree_edges:
            nx.draw_networkx_edges(G, pos, edgelist=dfs_tree_edges,
        ...
        for edges_sub, label_pos in [(edge_list[0::3], 0.25),
            ...
            if sub_labels:
                nx.draw_networkx_edge_labels(
                    G, pos, sub_labels, font_size=10,
                    label_pos=label_pos, ax=ax,
    ...
    def visualiser_arbre_dfs(self, parcours, parent, start_node, file_name='dfs_tree_visualization.png', fig=None):
        ...
        # Dessiner les nœuds
        nx.draw_networkx_nodes(
            G_tree, pos, node_color=node_colors,
        ...
        nx.draw_networkx_nodes(
            G_tree, pos, nodelist=[start_node],
